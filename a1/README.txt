...
# At first, 'conda' will show command not found
# buy this worked! source /opt/anaconda3/etc/profile.d/conda.sh

# it required 3.7, however, I only have 3.9 available so I changed the yml
